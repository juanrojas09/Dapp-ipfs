 ...
 */
  ...
  }*/ //no hace galta est funcion ni todo el tema del inner-text, etc, trabajo con el state y lo paso directo al html
...
reader.readAsArrayBuffer(file);
     reader.onloadend=()=>{
       this.setState({buffer:Buffer(reader.result)})//lo pongo en un state de react
...
onSubmit=async(event)=>{
  ...
  try{
       ...
       //this.state.contract.
        ...
        this.state.contract.methods.write(memHash).send({from: this.state.account},()=>{
